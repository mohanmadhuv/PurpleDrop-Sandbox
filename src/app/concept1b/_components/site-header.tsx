  ...
  return (
    <header className="w-full px-6 pt-6">
      <div className="flex items-center justify-between gap-6 lg:grid lg:grid-cols-3 lg:items-start">
        <Link href="/concept1b" className="flex shrink-0 items-center gap-3">
          <Image
            src="/logo.svg"
            alt="PurpleDrop"
            width={54}
        ...
        <nav className="hidden items-center gap-8 text-base font-normal tracking-tighter lg:col-start-3 lg:flex">
          {navLinks.map((link) => (
            <Link
              key={link.href}
              href={link.href}
